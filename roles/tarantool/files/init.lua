...
box.schema.user.create('tarantool',
                       {password = 'tarantool', if_not_exists = true})
...
accounts:format({
    ...
    {name = 'password', type = 'string'}, {name = 'is_active', type = 'boolean'}
})
