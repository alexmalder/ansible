...
c.fonts.downloads = '11pt Iosevka Nerd Font'
c.fonts.statusbar = '11pt Iosevka Nerd Font'
c.fonts.contextmenu = '11pt Iosevka Nerd Font'
c.fonts.messages.info = '11pt Iosevka Nerd Font'
c.fonts.debug_console = '11pt Iosevka Nerd Font'
c.fonts.completion.entry = '11pt Iosevka Nerd Font'
c.fonts.completion.category = '11pt Iosevka Nerd Font'
c.fonts.tabs.selected = '11pt Iosevka Nerd Font'
c.fonts.tabs.unselected = '11pt Iosevka Nerd Font'
...
c.colors.completion.item.selected.fg = base0C
...
c.colors.tabs.selected.odd.fg = base0C

# Background color of selected odd tabs.
c.colors.tabs.selected.odd.bg = base00

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = base0C
